...
INSERT INTO PSITOJXP.TERMS_AFTER
select pcr.policy_number,pcr.orig_policy_number,pcr.coverage_plan_code,pcr.ISSUE_STATE, trm.file_code
     , trm.trx_code, trm.effective_DAte, PCR.POLICY_EFFECT_DTE, PCR.COMM_OPTION_CODE
     , trm.trx_amount, pcr.policy_status, pcr.orig_admin_sys
  from psitoQ0D.pcr pcr, psitoQ0D.polhist trm, PSITOJXP.terms_init ult
    where pcr.company_code ='JPF'
     and ult.policy_number = pcr.policy_number
